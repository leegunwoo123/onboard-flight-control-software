...
//     // 요청된 채널 값을 반환
//     int raw_value = channels[channel - 1];
//     // // 스로틀(채널 3)과 제어 입력(채널 1, 2, 4)에 대해 매핑 수행
//     // if (channel == 3) { // 스로틀 채널
//     //     return mapThrottle(raw_value); // 수정된 부분
//     // } else if (channel == 1 || channel == 2 || channel == 4) { // 에일러론, 엘리베이터, 러더 채널
//     //     return mapControlInput(raw_value); // 수정된 부분
//     // } else {
//     //     return raw_value; // 기타 채널은 원래 값을 그대로 반환
//     // }
// }
